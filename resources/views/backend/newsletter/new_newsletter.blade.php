            ...
            <div class="col-md-12">
                      <div class="card-body">
                            <div class="form-group">
                              <label>電子報分類: <!-- Newsletter Classification --></label>
                              <div class="input-group">
                                ...
                                <select name="nl_classification" class="form-control custom-select" data-width="50%">
                                    ...
                                    <option value="REMA 電子報">REMA 電子報</option>
                                    <?php //  echo $all_groups;?>
                                </select>
                              </div>
                              <!-- /.input group -->
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" id="" name="nl_title" class="form-control" value="" placeholder="電子報標題">
                                </div>
                                <!-- /.input group -->
                              </div>
                              ...
                              <div class="form-group with-border">
                                ...
                                <div class="input-group">
                                <textarea id="p" class="form-control" rows="3" name="nl_content" placeholder="電子報內容"></textarea>
                              </div><!-- /.input group -->                      
                              </div>
                            ...
                            <?php //  echo "<script>CKEDITOR.instances.p.setData('".mysql_real_escape_string($product_description, $conn)."')</script>"; ?>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" id="" name="nl_author" class="form-control" value="" placeholder="電子報作者">
                                </div>
                                <!-- /.input group -->
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group">
                                  ...
                                  <input type="text" id="" name="nl_release" class="form-control datepicker" value="" placeholder="發佈時間">
                                </div>
                                <!-- /.input group -->
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group-prepend">
                                  ...
                                  <input type="text" id="" name="nl_update" class="form-control" value="" placeholder="更新時間" disabled >
                                </div>
                              </div><!-- /.input group -->    
